...
class RCli(RPackage):
    ...
    version('2.0.1', sha256='bedc6a61c1dd3a789105565ba919da8d3a2b78b238256bab99cd6222e7894874')
    ...
    depends_on('r-fansi', type=('build', 'run'), when='@2.0.0:')
    depends_on('r-glue', type=('build', 'run'), when='@2.0.0:')
